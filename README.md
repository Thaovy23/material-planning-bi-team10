...
- **Fact:** `FactMaterial` — purchasing transactions (OrderQty, ReceivedQty, Cost, TotalDue, etc)
- **Dimensions:** `DimProduct` · `DimVendor` · `DimDate` · `DimShipMethod`
- **Bridge:** `ProductVendor` — vendor terms (price, lead time, min/max order qty, etc)
